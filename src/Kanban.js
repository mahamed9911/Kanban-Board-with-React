...
const tasks = [
  { _id: 1, title: "Wagyu Steak", status: "backlog" },
  { _id: 2, title: "Oysters", status: "backlog" },
  { _id: 3, title: "Lobster", status: "backlog" },
  { _id: 4, title: "Filleting a fish", status: "new" },
  { _id: 5, title: "Accepting orders", status: "new" },
  { _id: 6, title: "Cleaning dishes", status: "going" },
  { _id: 7, title: "Lamb meat dish", status: "review" },
  { _id: 8, title: "Dessert menu", status: "review" },
  { _id: 9, title: "Store staffed", status: "done" },
  { _id: 10, title: "Store opened", status: "done" },
];
...
const classes = {
  ...
  column: {
    ...
    height: "80vh",
    margin: "0 auto",
    backgroundColor: "#1DB9AB",
  },
  columnHead: {
    textAlign: "center",
    padding: 10,
    fontSize: "1.2em",
    backgroundColor: "#0033DA",
    color: "white",
  },
  item: {
    padding: 10,
    ...
    return (
      <main>
        <header className="header">
          Stellar Culinary Kanban Board By Mahamed{" "}
        </header>
